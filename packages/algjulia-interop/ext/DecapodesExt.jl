...
function system(a::Types.Analysis)
    pode = diagram_to_pode(a.model, a.diagram)
    analysis = a.analysis
    @assert KeySet(:duration, :plotVariables, :domain, :mesh, :initialConditions, :scalars) == keys(analysis)
    mesh = loadmesh(
end
