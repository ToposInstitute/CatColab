...
defaults = [:Catlab,:ACSets,
            :DiagrammaticEquations,:Decapodes,:ACSets,:CombinatorialSpaces,:ComponentArrays,:StaticArrays,:LinearAlgebra,:Distributions,:OrdinaryDiffEq,:CoordRefSystems] # all extensions to date
