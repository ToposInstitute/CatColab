...
@testset "Analysis - Inverse Laplacian" begin
    analysis_json = open(JSON3.read, joinpath(@__DIR__, "test_jsons", "diagrams", "inverse_laplacian", "analysis_1.json"), "r")
...
@testset "Diagram - NS Vorticity" begin
    ...
    add_part!(handcrafted_pode, :Var, name=Symbol("•2"), type=:Form0)
    add_part!(handcrafted_pode, :Var, name=Symbol("•3"), type=:Form0)
    add_part!(handcrafted_pode, :Var, name=Symbol("•4"), type=:Form0)
    add_part!(handcrafted_pode, :Var, name=Symbol("•5"), type=:Form0)
    add_part!(handcrafted_pode, :Var, name=Symbol("•6"), type=:Form0)
    add_part!(handcrafted_pode, :Var, name=Symbol("•7"), type=:Form0)
    # tvar
    ...
    @test_broken diagram.pode == handcrafted_pode
end
# TODO not specifying initial boundary conditions for `B` on the front-end
# means that it will be automatically specified
