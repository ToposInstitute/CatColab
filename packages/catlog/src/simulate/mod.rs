...
models. It is intended as a stopgap solution pending interoperation with a
language having a better scientific computing ecosystem than Rust, such as
Julia. If this code does stick around it should eventually become its own crate.
