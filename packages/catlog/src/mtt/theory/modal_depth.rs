...
use crate::mtt::theory::{ListModality, Theory, TheoryArrow, TheoryObject, TheoryProArrow};
...
impl<T: Theory> ModalDepth for TheoryArrow<T> {
    fn modal_depth(&self) -> usize {
        match self {
            TheoryArrow::Generator { .. } | TheoryArrow::ModalStructureMap(_) => 0,
    ...
    fn increment_modal_depth(&self) -> Option<Self> {
        ...
        Some(TheoryArrow::ModalApplication(Box::new(self.clone())))
    }
