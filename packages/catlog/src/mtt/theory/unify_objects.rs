//! The default unification algorithm for theory objects. See
//! [default_unify_objects] for details.
        ...
        TheoryObject::ModalApplication(on) => {
            ...
            match default_unify_objects(&children) {
                UnificationResult::MostSpecific(child) => {
                    UnificationResult::MostSpecific(TheoryObject::ModalApplication(Box::new(child)))
                }
