//! All of the kinds of errors which may arise during checking raw ASTs.
...
pub enum EType {
    ...
    #[display("The variable {_0} is bound more than once in the domain binder")]
    /// A domain binder attempted to introduce the same variable more than once.
    DuplicateBinderVariable(String),
