 ...
 */
pub struct SwitchingMassActionAnalysis {
    ...
    /// Morphism types for switches for stocks to flows.
    pub switch_mor_type: TabMorType<Ustr, Ustr>,
}

impl Default for SwitchingMassActionAnalysis {
    fn default() -> Self {
        ...
        Self {
            ...
            switch_mor_type: TabMorType::Basic(ustr("Switch")),
        }
    }
}

impl SwitchingMassActionAnalysis {
