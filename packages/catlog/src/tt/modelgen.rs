...
impl Model {
    ...
    pub fn new(theory: &TheoryDef) -> Self {
        match theory {
            ...
            TheoryDef::DiscTab(theory) => {
                Model::DiscTab(Box::new(discrete_tabulator::DiscreteTabModel::new(theory.clone())))
            }
        }
    }
    ...
    fn id(&self, ob: Ob) -> Mor {
        all_the_same!(match self {
            Model::[Discrete, ModalUnital, DiscTab, ModalNonUnital](model) => {
    ...
    fn compose2(&self, mor1: Mor, mor2: Mor) -> Mor {
        all_the_same!(match self {
            Model::[Discrete, DiscTab, ModalUnital, ModalNonUnital](model) => {
    ...
    pub fn summary(&self, printer: &DblModelPrinter) -> String {
        all_the_same!(match self {
            Model::[Discrete, DiscTab, ModalUnital, ModalNonUnital](model) => printer.summary(model.as_ref())
        })
    }
