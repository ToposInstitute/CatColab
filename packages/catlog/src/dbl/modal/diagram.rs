...
/// A diagram is a model of a modal double theory.
...
impl Diagram for ModalDblModelDiagram {
    type Model = ModalDblModel<Unital>;
    type Mapping = ModalDblModelMapping;
    type InvalidDiagram = InvalidModalDblModelDiagram;

    /// Destructures the diagram
    ...
    fn infer_missing_from(&mut self, model: &ModalDblModel<Unital>) {
