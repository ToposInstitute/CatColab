We might want to think about Lotka–Volterra dynamics whenever influence between variables is _bidirectional_, e.g. for predator-prey models, where higher population of predators means lower population of prey, which means lower population of predators, and so on.
