...
We might want to think about Lotka–Volterra dynamics whenever influence between variables is *bidirectional*, e.g. for predator-prey models, where higher population of predators means lower population of prey means lower population of predators means ... and so on.
