...
**Petri nets** are traditionally a way of expressing discrete-event dynamical systems with concurrency, describing how various states (called **places**) relate to one another in terms of **transitions**.
