...
Stocks are interpreted as quantities that can vary in time ("concentrations"), and the flows and links ("reactions") in the model determine equations constraining the time derivatives of the stocks.
