...
Just as for usual mass-action dynamics, since these stock-flow diagrams are primitive, flows are determined by their **consumption** and **production** coefficients, $\kappa$ and $\rho$ respectively.
</HelpAnalysisById>
