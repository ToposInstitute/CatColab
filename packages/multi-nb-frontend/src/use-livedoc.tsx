...
export const LIVEDOC_CONTEXT = createContext<{
    repo: Repo;
...
export function getDocumentValue<T>(id: AnyDocumentId): T | undefined {
    const livedocs = useContext(LIVEDOC_CONTEXT);
    ...
    return livedocs.repo.find(id)?.docSync() as T | undefined;
}
