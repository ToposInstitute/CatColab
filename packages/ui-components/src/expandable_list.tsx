...
export function ExpandableList<T>(props: {
    /** Array of items to display */
    items: T[];
    /** Number of items to show before truncation */
    threshold?: number;
    ...
    return (
        <div class={styles.expandableList}>
            ...
            <div class={styles.expandableListItems}>
                <For each={visibleItems()}>{(item, index) => props.renderItem(item, index())}</For>
            </div>
