...
export type StreamMsg = { status: string } | { progress: number } | { data: unknown };
...
export function ProgressBar(props: { progress: () => number | null; status: () => string | null }) {
    return (
        <Switch fallback="Running the simulation...">
            ...
            <Match when={props.progress() != null}>
                <div class="simulation-progress">
                    ...
                    <span class="progress-label">{(props.progress()! * 100).toFixed(0)}%</span>
                </div>
            </Match>
        </Switch>
    );
