...
framework concerns with the modeling API. Additionally we have had no explicit
API for document manipulation so UI components are currently performing direct
JSON manipulation.
