...
kind of document currently in use, but API should be extendable to other kinds
...
writing code, not just supplying data, it has the significant advantage that:
