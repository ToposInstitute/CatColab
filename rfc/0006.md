...
#### Phase 3: CatColab "scripts" & GAIOS demo

Our initial user-facing feature will be a way a visitor can write Javascript
that makes use of this API to create and edit notebooks.

At the same time we can build a demo of this API being used with the GAIOS LLM skill system.
