...
let
  ...
  julia = pkgs.stdenv.mkDerivation {
    ...
    src = pkgs.fetchurl {
      url = "https://julialang-s3.julialang.org/bin/linux/x64/1.12/julia-${juliaVersion}-linux-x86_64.tar.gz";
      sha256 = "sha256-QbhNcn5Olvvz7Z6S+hlddz0ke5CX9z+taI+LaZdYuuc=";
    };
